...
<body>
<form action="{{url('/curd/update/assi')}}" method="post">


<div class="col-lg-12">
  
    <center><div class="card-header" style="background-color: #3a3abc;border-radius: 40px;width: 800px;height: 40px;margin-top: 20px;">
      <h3 style="margin-top: -11px"> <center><span style="color: white">Edit Assignment</span></center></h3>
    </div></center>
...
<div class="form-group"><label for="Subject Name" class=" form-control-label">Subject Name</label>
  <input type="text" id="Subject Name" placeholder="Enter Subject Name" class="form-control" name="subjectname" value="{{$curds->subjectname}}"></div>
</div>

<div class="col-8">
<div class="form-group"><label for="Content " class=" form-control-label">Subject Code</label>
  <input type="text" id="subjectcode" placeholder="Enter subjectcode" class="form-control" name="subjectcode" value="{{$curds->subjectcode}}"></div>
</div>
